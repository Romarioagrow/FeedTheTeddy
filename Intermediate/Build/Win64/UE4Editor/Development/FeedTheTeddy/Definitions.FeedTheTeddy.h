...
#define UE_PROJECT_NAME FeedTheTeddy
#define UE_TARGET_NAME FeedTheTeddyEditor
#define UE_MODULE_NAME "FeedTheTeddy"
...
#define FEEDTHETEDDY_API DLLEXPORT
